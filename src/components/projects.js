...
import ProjectList from "../libs/projectList" //实例
import Project from '../libs/project';//函数
...
class Projects extends Component{
        ...
        <div className="panel panel-default">
            ...
            <div className="panel-body">
              ...
              <div className="progress">
                <div aria-valuenow=""  className="progress-bar progress-bar-striped active" role="progressbar" aria-valuemin="0" aria-valuemax="100" style={{width:"20%"} }>
                  {/* <span className="sr-only">45% Complete</span> */}
                  {project.balance%project.goal}
                </div>
              </div>
  ...
  async componentDidMount(){
    ...
    console.log(ProjectList.methods.getProjects().call())
